    ...
    return (
            ...
            >
                ...
                <svg className={styles.svg} width={svgDimensions} height={svgDimensions}>
                    ...
                    <circle cx={center} cy={center} r={innerRadius} className={styles.innerCircle} fill="var(--primary-dark)" />
                    ...
                    <g id="time-marker-wrapper">
                        {timeMarkers.map( marker => (
                            <g key={marker} className={styles.markerWrapper} style={{transform: `rotate(${timeMarkers.indexOf(marker)*15}deg)`}}>
                                <text textAnchor="middle" x={-26} y={404} fill="#f8f8ff" className={styles.marker} style={{transform: `rotate(${timeMarkers.indexOf(marker)*-15}deg)`}}>{marker}</text>
                            </g>
                        ))}
                    </g>
