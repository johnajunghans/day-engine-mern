...
import AddRoutineForm from "../form-comps/AddRoutineForm";
    ...
    return ( 
        <>
            ...
            >
                ...
                <CircularAddBtn btnSize="40px" iconSize="16px" handleClick={onRoutineOpen} tooltip="Create New Routine" />
            </Flex>
            <AddModal 
                isOpen={isRoutineOpen} 
                onClose={onRoutineClose} 
                header="Add New Routine"
                submitButtonText="Create New Routine"
            >
                <AddRoutineForm />
            </AddModal>
        </>
